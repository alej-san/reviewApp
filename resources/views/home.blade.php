...
<aside><div class="sidenav position-sticky d-flex flex-column justify-content-between">
    ...
    <div class="navbar navbar-dark my-4 p-0 font-primary">
        <ul class="navbar-nav w-100">
            ...
            <li class="nav-item">
                <a class="nav-link text-white px-0 pt-0" href="{{session(['tipo' => '$type->id'])}}">{{ $type->tipo  }}</a>
            </li>
            @endforeach
        ...
        <div class="container pt-4 mt-5">
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/post/create') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Create new post</a>
                    @else
            ...
            @endif
                    ...
                    <div class="card post-item bg-transparent border-0 mb-5">
                        ...
                        <div class="card-body px-0">
                            <h2 class="card-title">
                                <a class="text-white opacity-75-onHover" href="{{ url('/post/'. $post->id)  }}">
                                   {{ $post->title}}
                                    </a>
                            </h2>
                            <ul class="post-meta mt-3">
                                ...
                                <li class="d-inline-block">
                                    ...
                                    <a class="ml-1" href="#">{{ $post->tipos->tipo}}</a>
                                </li>
                            </ul>
                            <p class="card-text my-4">{{$post->message}}</p>
                            <a href="{{ url('/post/'. $post->id)  }}" class="btn btn-primary">Read More <img src="images/arrow-right.png" alt=""></a>
                        </div>
                    </div>
                    <!-- end of post-item -->
                ...
                <div class="col-lg-4 col-md-5">
                    <div class="widget text-center">
                        ...
                        <h2 class="widget-title text-white d-inline-block mt-4">{{Auth::user()->name}}</h2>
