            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="contact-form bg-dark">
                        ...
                        <form action="{{url('post/' . $post->id)}}" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" placeholder="Post title" value="{{ old('post', $post->title) }}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input value="{{ old('post', $post->file) }}" type="file" name="file" id="file"/>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <textarea name="message" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" placeholder="Lorem Ipsum is simply dummy text of the printing and..." required>{{ old('post', $post->message) }}</textarea>
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-sm btn-primary">Send Now <img src="{{url('images/arrow-right.png')}}" alt=""></button>
                                </div>
                            </div>
                        </form>
                    </div>
