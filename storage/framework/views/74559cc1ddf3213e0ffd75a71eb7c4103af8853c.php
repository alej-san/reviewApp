            ...
            <div class="input-group">
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-10">
                        ...
                        <a href=" <?php echo e(url('post/' . $post->id . '/edit')); ?> " class="btn btn-primary">Edit <img src="images/arrow-right.png" alt=""></a>
                        
                         <a href="javascript: void(0);" 
                                       data-name="<?php echo e($post->title); ?>"
                                       data-url="<?php echo e(url('post/' . $post->id )); ?>"
                                       data-toggle="modal"
                                       data-target="#modalDelete">delete</a>
                        <?php endif; ?>
                        <?php endif; ?>
                        <h1 class="text-white add-letter-space mt-4"><?php echo e($post->title); ?></h1>
                        ...
                        <img src="<?php echo e(asset('storage/postpics/20221215224045.jpg')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Goodreads/resources/views/posts/show.blade.php ENDPATH**/ ?>