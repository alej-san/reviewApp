            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="contact-form bg-dark">
                        ...
                        <form action="<?php echo e(url('post/' . $post->id)); ?>" enctype="multipart/form-data" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" placeholder="Post title" value="<?php echo e(old('post', $post->title)); ?>" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input value="<?php echo e(old('post', $post->file)); ?>" type="file" name="file" id="file"/>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <textarea name="message" class="form-control bg-transparent rounded-0 border-bottom shadow-none pb-15 px-0" placeholder="Lorem Ipsum is simply dummy text of the printing and..." required><?php echo e(old('post', $post->message)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Goodreads/resources/views/posts/edit.blade.php ENDPATH**/ ?>